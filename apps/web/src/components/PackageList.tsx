                ...
                <div className="flex-1">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">Created {new Date(pkg.createdAt).toLocaleDateString()}</p>
                    </div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-lg font-bold text-gray-900 mb-1">¥{pkg.cost.toLocaleString()}</div>
